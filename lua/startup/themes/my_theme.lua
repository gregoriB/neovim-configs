local settings = {
    ...
    body = {
        ...
        content = {
            ...
            { "🔍  Find a Project File", "Telescope find_files", "space space" },
            { "⏳  Browser Recent Files", "Telescope oldfiles", "space enter" },
    ...
    clock = {
        type = "text",
        content = function()
            local clock = "⌚️  " .. os.date("%H:%M")
            local date = "🗓️  " .. os.date("%d-%m-%y")
            return { clock, date }
        end,
        oldfiles_directory = false,
        align = "center",
